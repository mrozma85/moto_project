...
namespace MotoAPI.Migrations
{
    ...
    [Migration("20231129194113_UpdateImagesCollection1")]
    partial class UpdateImagesCollection1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moto_API.Models.Image", b =>
                {
                    b.HasOne("Moto_API.Models.Vehicle", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Moto_API.Models.VehicleImages", b =>
                {
                    b.HasOne("Moto_API.Models.Vehicle", "Vehicle")
                        .WithMany()
                        .HasForeignKey("VehicleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
